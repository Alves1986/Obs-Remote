...
/* 
  ...
  Copie e cole o código abaixo no SQL Editor do Supabase para corrigir o erro.
  Este código foi simplificado para evitar erros de sintaxe.

  -- 1. Limpeza (opcional, caso a tabela tenha sido criada com erro)
  drop table if exists connection_presets;

  -- 2. Criação da Tabela
  create table connection_presets (
  ...
  -- 3. Segurança (Habilita acesso para o app)
  alter table connection_presets enable row level security;
  
  create policy "Public Access" 
  on connection_presets 
  for all 
  using (true);
*/
